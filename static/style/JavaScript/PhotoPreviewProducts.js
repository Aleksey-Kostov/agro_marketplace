document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleFileInputChange(inputId, previewId) {
        ...
        // Ensure that the file input element exists before adding the event listener
    ...
    // Attach event listeners to all four file inputs (if they exist)
    ...
    // Function to handle price type field visibility
    ...
    if (priceTypeField && pricePerUnitContainer && priceAllQuantityContainer) {
